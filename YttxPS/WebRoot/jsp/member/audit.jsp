...
<body class="no-skin">
										...
										<form class="form-horizontal" role="form" id="queryfield">
											<div class="form-group">
												<label class="col-sm-1 control-label no-padding-right"
													for="auditno">审核编号</label>
												<div class="col-sm-2">
													<input maxlength="20" type="text" id="auditno"
														placeholder="审核编号" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-1 control-label no-padding-right"
													for="audittype">审核类型</label>
												<div class="col-sm-2">
													<select id="audittype">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input class="col-sm-5 col-xs-5" maxlength="150"
														type="text" id="name" placeholder="客户名称" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-1 control-label no-padding-right"
													for="taname">旅行社名称</label>
												<div class="col-sm-10">
													<input class="col-sm-5 col-xs-5" maxlength="150"
														type="text" id="taname" placeholder="旅行社名称" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-1 control-label no-padding-right"
													for="auditret">审核结果</label>
												<div class="col-sm-1">
													<select id="auditret">
	...
	<!-- /.main-container -->
	<script src="/js/bus/member/audit.js"></script>
</body>
</html>
