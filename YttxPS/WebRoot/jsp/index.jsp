							...
							<div id="login-box" class="login-box visible widget-box no-border">
								<div class="widget-body">
										...
										<form action="login.htm" method="post" id="login-form">
											<fieldset>
												<label class="block clearfix">
													...
													<i class="fa fa-user ace-icon"></i>
												</span>
												</label>
												<label class="block clearfix">
													<span class="block input-icon input-fa fa-right">
														<input type="password" class="form-control" placeholder="密码" id="password" name="password" />
														<i class="fa fa-lock ace-icon"></i>
													</span>
												</label>
												<div class="space"></div>
												<div class="clearfix">
													<label class="inline">
														<input type="checkbox" id="rememberflag" name="rememberflag" class="ace" />
									...
									<div class="toolbar clearfix">
										<div>
											<a href="#" onclick="show_box('forgot-box'); return false;" class="forgot-password-link"> <i class="fa fa-arrow-left"></i> 忘记密码?
											</a>
										</div>
									</div>
								</div>
							...
							<div id="forgot-box" class="forgot-box widget-box no-border">
								<div class="widget-body">
									...
									<div class="toolbar center">
										<a href="#" onclick="show_box('login-box'); return false;" class="back-to-login-link"> 返加登录 
