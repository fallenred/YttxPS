...
<script id="tr-mplist" type="text/x-handlebars-template">
	<tr class="width-14">
		...
		<td><input type="text" value="{{mpPrice}}" class="mpPrice isFloatGteZero number input-text" name="body.costdetails.ticket.reslist[{{index}}].unitprice"></td>
		<td><input type="text" value="{{mpCount}}" class="mpCount isFloatGteZero number input-text" name="body.costdetails.ticket.reslist[{{index}}].number"></td>
