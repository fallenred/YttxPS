	...
	<table class="table table-bordered">
		...
		<tbody class="qtzc_tbody">
			...
			<tr>
				...
				<td colspan="4" style="text-align: left;"><input type="text" readonly="readonly" value="" style="width:100%;" class="qtzcTotal" id="qtzcTotal" name="body.costdetails.other.total"></td>
