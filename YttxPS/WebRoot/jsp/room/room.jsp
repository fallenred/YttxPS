...
<body>
	<div class="main-container" id="main-container">
				...
				<div class="modal-content">
					...
					<form class="form-horizontal" id="addform">
						<div class="modal-body">
							...
							<div class="row">
								<div class="form-group">
									<label class="col-sm-2 control-label no-padding-right" for="regdate">三餐情况</label>
									<div class="col-sm-8">
										<label>
											<input name="fsMeal1" class="ace ace-switch ace-switch-2" type="checkbox">
											<span class="lbl">&nbsp;早餐</span>
										</label>
										<label>
											<input name="fsMeal2" class="ace ace-switch ace-switch-2" type="checkbox">
											<span class="lbl">&nbsp;中餐</span>
										</label>
										<label>
											<input name="fsMeal3" class="ace ace-switch ace-switch-2" type="checkbox">
						...
						<div class="modal-body">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="hidden" name="fsRoomno" class="form-control" placeholder="房型唯一编号" />
										<input type="text" name="fsAccomno" class="form-control" placeholder="酒店代码" readonly="readonly" />
									</div>
		...
		<!-- 模态框（查询） -->
		<div class="modal fade" id="showRoomModal" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						...
						<div class="modal-body">
							<div class="row">
								<div class="form-group">
									<label class="col-sm-2 control-label no-padding-right" for="company">酒店代码</label>
									<div class="col-sm-4">
										<input type="text" name="fsAccomno" class="form-control" placeholder="酒店代码" disabled="disabled" />
									</div>
									<label class="col-sm-2 control-label no-padding-right" for="load">房型类型</label>
									<div class="col-sm-4">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<label>
											<input name="fsMeal1" disabled="disabled" class="ace ace-switch ace-switch-2" type="checkbox">
											<span class="lbl">&nbsp;早餐</span>
										</label>
										<label>
											<input name="fsMeal2" disabled="disabled" class="ace ace-switch ace-switch-2" type="checkbox">
											<span class="lbl">&nbsp;中餐</span>
										</label>
										<label>
											<input name="fsMeal3" disabled="disabled" class="ace ace-switch ace-switch-2" type="checkbox">
											<span class="lbl">&nbsp;晚餐</span>
										</label>
									</div>
								</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" id="delForm">
							<input type="hidden" name="fsRoomno" />
