...
<body class="no-skin">
								...
								<div class="panel-collapse collapse in" id="collapseOne">
									<div class="panel-body">
										<form class="form-horizontal" role="form" id="queryfield">
											...
											<div class="form-group">
												<label class="col-sm-1 control-label no-padding-right"
													for="fsRoutename">线路名称</label>
												<div class="col-sm-2">
													<input maxlength="150"
														type="text" id="fsRoutename" placeholder="线路名称" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-1 control-label no-padding-right"
								...
								<div class="modal-dialog" style="width: 1024px;">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal"
												aria-hidden="true">×</button>
											<h4 class="modal-title" id="addModalLabel">修改结算单</h4>
										</div>
										<div class="modal-body">
											<iframe id="editIframe" width="100%" height="1100px"
												frameborder="0" scrolling="no"></iframe>
										</div>
										<!-- /.modal-content -->
									</div>
	...
	<!-- /.main-container -->
	<script src="/js/bus/closelist/closelist.js"></script>
</body>
</html>
