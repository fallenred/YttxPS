...
<body>
						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="showModalLabel">结算单详情</h4>
								</div>
								<div class="modal-body">
									...
									<div class="row">
										...
										<!-- <label class="col-sm-2 control-label no-padding-right" for="fsOrderId">订单编号</label>
											...
											<div class="col-sm-2">
												<input type="hidden" id="fsOrderId" name="fsOrderId" class="form-control" placeholder="用户id"  />
												<input type="text" id="fsOrderName" name="fsOrderName" class="form-control" placeholder="用户名称"  />
	...
	<!-- /.main-container -->
	<script src="/js/bus/closelist/show.js"></script>
