								...
								<div class="modal-body">
									...
									<div class="row">
										<div class="form-group">
											...
											<label class="col-sm-2 col-md-offset-2 control-label no-padding-right" for="ftEnddate">淡季结束日期</label>
											<div class="col-sm-2">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[0].fsCcno" value="000001">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[1].fsCcno" value="000002">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[2].fsCcno" value="000003">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[3].fsCcno" value="000004">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[4].fsCcno" value="000005">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[5].fsCcno" value="000006">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[6].fsCcno" value="000007">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[7].fsCcno" value="000008">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[8].fsCcno" value="000009">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[9].fsCcno" value="000010">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[10].fsCcno" value="000011">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[11].fsCcno" value="000012">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[12].fsCcno" value="000013">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[13].fsCcno" value="000014">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[14].fsCcno" value="000015">
											...
											<div class="col-sm-2">
												<input class="form-control" type="hidden" name="tccPrices[15].fsCcno" value="000016">
