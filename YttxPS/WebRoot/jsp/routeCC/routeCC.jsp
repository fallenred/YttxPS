...
<body class="no-skin">
								...
								<div class="modal-dialog" style="width: 1024px;">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" id="addModalLabel">新增路线行程</h4>
										</div>
										<div class="modal-body">
											<iframe id="addIframe" width="100%" height="900px" frameborder="0" scrolling="no"></iframe>
										</div>
							...
							<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
								<div class="modal-dialog" style="width: 1024px;">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
											<h4 class="modal-title" id="editModalLabel">修改路线行程</h4>
										</div>
										<div class="modal-body">
											<iframe id="editIframe" width="100%" height="1200px" frameborder="0" scrolling="no"></iframe>
										</div>
							...
							<div class="modal fade" id="showModal" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="false">
								<div class="modal-dialog" style="width: 1024px;">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
											<h4 class="modal-title" id="showModalLabel">展示路线行程</h4>
										</div>
										<div class="modal-body">
	...
	<!-- /.main-container -->
	<script src="/js/bus/routeCC/routeCC.js"></script>
</body>
</html>
