...
<body>
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												...
												<input class="form-control priceisFloatGteZero number" maxlength="10" type="text" id="fdfreelowqp" name="tccPrices[3].fdPrice" placeholder="挂牌价格免票" />
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-sm-3">
												...
												<input class="form-control price isFloatGteZero number" maxlength="10" type="text" id="fdtranscoststp" name="tccPrices[16].fdPrice" placeholder="接送费用" />
											</div>
										</div>
									</div>
	...
	<!-- /.main-container -->
	<script src="/js/bus/entertainmentPrice/add.js"></script>
