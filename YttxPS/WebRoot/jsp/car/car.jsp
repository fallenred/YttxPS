...
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
										...
										<form class="form-horizontal" role="form" id="queryfield">
											<div class="form-group">
												<label class="col-sm-1 control-label no-padding-right"
													for="no">车牌号</label>
												<div class="col-sm-2">
													<input maxlength="10" name="no" type="text" id="no"
														placeholder="忽略车牌号" />
												</div>
											</div>
											<div class="form-group">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class=" col-xs-8 col-sm-6">
										...
										<input type="hidden" class="car_driver_input" name="driverindex" width="100%"
											class="form-control" placeholder="驾驶员信息展示" />
									</div>
									<a class="col-xs-3 col-sm-2 control-label" id="carDirverSearchButtom">选择驾驶员</a>
								</div>
							</div>
							<div class="row">
								<label class="col-xs-2 col-sm-2 control-label no-padding-right"
					...
					<form class="form-horizontal" id="editForm">
						<div class="modal-body">
							...
							<div class="row">
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right"
										for="addr">驾驶员信息</label>
									<div class="col-sm-12">
										<span>驾驶员信息</span> <input type="hidden" name="driverindex"
											class="form-control" placeholder="驾驶员信息" />
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="form-group">
									<label class="col-sm-1 control-label no-padding-right"
										for="addr">驾驶员信息</label>
									<div class="col-sm-12">
										<input type="text" name="driverindex" width="100%"
											class="form-control" placeholder="驾驶员信息" />
									</div>
								</div>
							</div>
		...
		<div class="modal fade" id="carDirverSearchModal" tabindex="-1"
			role="dialog" aria-labelledby="showModalLabel" aria-hidden="false">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
					...
					<form class="form-horizontal" id="carDirverSearchForm">
						<div class="modal-body" align="center">
							<div class="form-group" align="center">
								<label class=" control-label no-padding-right" for="name">驾驶员姓名</label>
								&nbsp; <input maxlength="10" type="text" id="name"
									placeholder="忽略驾驶员姓名" /> &nbsp;
								<button id="driver_submit" type="button"
						...
						<div class="modal-footer">
							<button id="close" type="button" class="btn btn-default"
								data-dismiss="modal">关闭</button>
							<button id="enter_driver_sumit" type="button" class="btn btn-pink"
