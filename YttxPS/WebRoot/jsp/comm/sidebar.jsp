		...
		try {
			...
			var forTree = function(element, menus){
			 for(var i=0;i<menus.length;i++){
			 	var $litag = null;
				if(menus[i]["url"] != null){
					var $atag = $('<a/>').attr('href', menus[i]['url']).html(menus[i]['name']).append($('<i/>').addClass('icon-double-angle-right'));
					...
					if(menus[i]['hasActive'] == true){
			 		...
			 		var $btag = $('<b/>').addClass('arrow icon-angle-down');		 
		...
		<li><a href="#" class="dropdown-toggle"> <i
			...
			<ul class="submenu">
				...
				<li><a href="treeview.html"> <i
						class="icon-double-angle-right"></i> 树菜单 </a>
				</li>
		...
		<li><a href="#" class="dropdown-toggle"> <i class="icon-list"></i>
			...
			<ul class="submenu">
				<li><a href="tables.html"> <i
						class="icon-double-angle-right"></i> 简单 &amp; 动态 </a>
				</li>

				<li><a href="jqgrid.html"> <i
						class="icon-double-angle-right"></i> jqGrid plugin </a>
				</li>
			</ul>
		</li>
		...
		<li><a href="#" class="dropdown-toggle"> <i class="icon-tag"></i>
			...
			<ul class="submenu">
				...
				<li><a href="inbox.html"> <i
						class="icon-double-angle-right"></i> 收件箱 </a>
				</li>

				<li><a href="pricing.html"> <i
						class="icon-double-angle-right"></i> 售价单 </a>
				</li>

				<li><a href="invoice.html"> <i
						class="icon-double-angle-right"></i> 购物车 </a>
				</li>

				<li><a href="timeline.html"> <i
						class="icon-double-angle-right"></i> 时间轴 </a>
				</li>
