...
<body>
		...
		<div class="main-container-inner">
										...
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input type="text" id="no" name="no" class="form-control"
													placeholder="景区编码需唯一"  maxlength="10"/>
											</div>
            ...
            <script>
                ...
                CKEDITOR.replace( 'desc' , {
                	filebrowserBrowseUrl: 'http://127.0.0.1:81/resources',
                    filebrowserUploadUrl: '/pic/addLinePic.htm'
                });
            </script>
											</div>
										</div>
	...
	<!-- /.main-container -->
	<script src="/js/bus/scenic/add.js"></script>
