...
<body class="no-skin">
									...
									<div class="panel-body">
										<form class="form-horizontal" role="form" id="queryfield">
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input class="form-control" maxlength="10" type="text" id="no" placeholder="导游编号" />
												</div>
		...
		<div class="modal fade" id="showModal" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="false">
			<div class="modal-dialog" style="width: auto; height: auto">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						<h4 class="modal-title" id="showModalLabel">查看导游信息</h4>
					</div>
					<div class="modal-body">
	...
	<!-- /.main-container -->
	<script src="/js/bus/guide/guide.js"></script>
</body>
</html>
